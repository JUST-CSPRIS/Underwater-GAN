...
from PyTorch.nets.enhanced import EnhancedGenerator
...
parser.add_argument("--data_dir", type=str, default="/home/xie/xcl/paper/data/UFOtest/TEST/lrd")
# parser.add_argument("--data_dir", type=str, default="/home/xie/xcl/paper/data/SUIM/TEST/images/")
# parser.add_argument("--data_dir", type=str, default="/home/xie/xcl/paper/data/U45/")
parser.add_argument("--sample_dir", type=str, default="data/ufo/")
parser.add_argument("--model_name", type=str, default="funiegan") # or "ugan"‘funiegan’
parser.add_argument("--model_path", type=str, default="/home/xie/xcl/paper/code/FUnIE-GAN-master/PyTorch/checkpoints测试/测试2/UFO-120/generator_200.pth")
