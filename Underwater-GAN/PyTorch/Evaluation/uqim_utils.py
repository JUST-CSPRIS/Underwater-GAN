...
def _uiconm(x, window_size):
    """
      ...
      <url id="cv6nar3mv21hrkd9h9pg" type="url" status="parsed" title="UIQM/src/uiconm.cpp at master · tkrahn108/UIQM" wc="16">https://github.com/tkrahn108/UIQM/blob/master/src/uiconm.cpp</url>
      <url id="cv6nar3mv21hrkd9h9q0" type="url" status="parsed" title="Parameterized Logarithmic Framework for Image Enhancement" wc="1701">https://ieeexplore.ieee.org/abstract/document/5609219</url>
    """
    plip_lambda = 1026.0
    plip_gamma  = 1026.0
    plip_beta   = 1.0
...
def getUIQM(x):
    ...
    print("Input array type:", x.dtype)
